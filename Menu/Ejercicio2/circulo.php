<?php
    ...
    //CÍRCULO
    if($radioC>0){
        $areaCi=pi()*$radioC*$radioC;
        $perimetroCi=2*pi()*$radioC;
    }else{
        $areaCi='---';
        $perimetroCi='---';
    }
            ...
            <div class="align-items-center justify-content-between"><br>
                <form name="calculoAreaPerimetro" class="border p-5 form">
                    ...
                    <div class="form-group row" style="justify-content: center;">
                        <div class="col-sm-6">
                            <label for="radioC" class="col-form-label">Radio: <?=$radioC?> </label>
                        </div>
                    </div>
                    <div class="form-group row" style="justify-content: center;">
                        <div class="col-sm-6">
                            <label for="areaT" class="col-form-label">Área: </label>
                            <input type="text" class="form-control" name="areaCi" disabled placeholder=<?=$areaCi?> >
                        </div>
                        <div class="col-sm-6">
                            <label for="perimetroT" class="col-form-label">Perímetro:</label>
                            <input type="text" class="form-control" name="perimetroCi" disabled placeholder=<?=$perimetroCi?>>
                        </div>
                    </div>
                    <div class="form-group row" style="justify-content: center;">
                        <div class="col-sm-6">
                            <a href="circulo.html" style="text-decoration: none;"><input type="button" class="btn btn-primary btn-user btn-block" value="OTRO CÁLCULO "></a>
                        </div>
                    </div>
                </form>
            </div>
